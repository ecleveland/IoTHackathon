...
namespace adafruitProto
{
    class Program
    {
        static DeviceClient deviceClient;
        static string iotHubUri = "dns.azure-devices.net";
        static string deviceKey = "K6bzg7DGX8D6r9LUTkNAyPzw71MDFRlymSU7MDHmjV4=";
        static string deviceId = "adafruitProto1";
        ...
        private static async void SendDeviceToCloudMessagesAsync()
        {
            ...
            double lat = 47.6124876;
            double lon = -122.2048304;
